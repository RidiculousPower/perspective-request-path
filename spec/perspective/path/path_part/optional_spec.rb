...
describe ::Perspective::Request::Path::PathPart::Optional do
	...
	it 'can initialize with nested parts' do
	  ...
	  optional_sub_part = ::Perspective::Request::Path::PathPart::Optional.new( 'other' )
	  optional_part = ::Perspective::Request::Path::PathPart::Optional.new( 'path', 'to', optional_sub_part )
	  ...
	  optional_sub_two_sub_part = ::Perspective::Request::Path::PathPart::Optional.new( 'or', 'two' )
	  optional_sub_part_two = ::Perspective::Request::Path::PathPart::Optional.new( 'and', 'option', optional_sub_two_sub_part )
	  optional_part = ::Perspective::Request::Path::PathPart::Optional.new( 'some', optional_sub_part_one, 'constant', optional_sub_part_two )
