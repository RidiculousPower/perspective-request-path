...
describe ::Perspective::Request::Path::RequestPath do

  before :all do
    
    class ::Perspective::Request::Path::RequestPath::MockPath
    ...
    class ::Perspective::Request::Path::RequestPath::MockPath::Part
    ...
    class ::Perspective::Request::Path::RequestPath::MockPath::Part::Fragment
    ...
    @mock_path_part_one = ::Perspective::Request::Path::RequestPath::MockPath::Part.new
    @mock_path_part_two = ::Perspective::Request::Path::RequestPath::MockPath::Part.new
    @mock_path_part_three_fragment_one = ::Perspective::Request::Path::RequestPath::MockPath::Part::Fragment.new( 0, 2 )
    @mock_path_part_three_fragment_two = ::Perspective::Request::Path::RequestPath::MockPath::Part::Fragment.new( 2, 1 )
    @mock_path_part_three_fragment_three = ::Perspective::Request::Path::RequestPath::MockPath::Part::Fragment.new( 3, 1 )
    @mock_path_part_three = ::Perspective::Request::Path::RequestPath::MockPath::Part.new( @mock_path_part_three_fragment_one, @mock_path_part_three_fragment_two, @mock_path_part_three_fragment_three )
    @mock_path = ::Perspective::Request::Path::RequestPath::MockPath.new( @mock_path_part_one, @mock_path_part_two, @mock_path_part_three )
  ...
  it 'can create a new stack frame' do
    ...
    request_path.instance_eval do
      ...
      first_frame.is_a?( ::Perspective::Request::Path::RequestPath::FrameStruct ).should == true
      ...
      second_frame.is_a?( ::Perspective::Request::Path::RequestPath::FrameStruct ).should == true
  ...
  it 'can create a new fragment stack frame' do
    ...
    request_path.instance_eval do
      ...
      first_fragment_frame.is_a?( ::Perspective::Request::Path::RequestPath::FragmentFrameStruct ).should == true
      ...
      second_fragment_frame.is_a?( ::Perspective::Request::Path::RequestPath::FragmentFrameStruct ).should == true
  ...
  it 'can return the current stack frame' do
    ...
    request_path.instance_eval do
      frame = current_frame
      frame.is_a?( ::Perspective::Request::Path::RequestPath::FrameStruct ).should == true
  ...
  it 'can return the current fragment stack frame' do
    ...
    request_path.instance_eval do
      ...
      fragment_frame.is_a?( ::Perspective::Request::Path::RequestPath::FragmentFrameStruct ).should == true
