...
describe ::Magnets::Path::PathPart::Optional::NamedOptional do
	...
	it 'can initialize with nested parts' do
	  ...
	  optional_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'some', :two => 'path', :three => 'to', :four => 'constant' )
	  ...
	  optional_sub_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :sub_part => 'other' )
	  optional_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'path', :two => 'to', :three => optional_sub_part )
	  ...
	  optional_sub_one_sub_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'path', :two => 'to' )
	  optional_sub_part_one = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'other', :two => optional_sub_one_sub_part )
	  optional_sub_two_sub_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'or', :two => 'two' )
	  optional_sub_part_two = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'and', :two => 'option', :three => optional_sub_two_sub_part )
	  optional_part = ::Magnets::Path::PathPart::Optional::NamedOptional.new( :one => 'some', :two => optional_sub_part_one, :three => 'constant', :four => optional_sub_part_two )
