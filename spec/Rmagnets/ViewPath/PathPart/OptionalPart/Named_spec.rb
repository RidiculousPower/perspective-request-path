...
describe Rmagnets::ViewPath::PathPart::OptionalPart::Named do
  ...
  it 'can match optional parts' do
    ...
    remaining_request_path_parts  = [ 'optional_descriptor_hash1', 'optional_descriptor_hash2', 'optional_descriptor_hash3', 'optional_descriptor_hash4', 'path', 'part' ]
    $optional_descriptor_hash.match_option_descriptors_for_optional_set( optional_set, remaining_descriptor_elements, remaining_request_path_parts ).should == [ 'optional_descriptor_hash1', 'optional_descriptor_hash2', 'optional_descriptor_hash3', 'optional_descriptor_hash4' ] 
