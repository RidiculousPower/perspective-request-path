...
module ::Magnets::Path::PathPart::Fragment
  ...
  def self.new( path_descriptor, multiple_capturing_fragments )
    ...
    case path_descriptor
		    ...
		    ::Magnets::Path::Parser.parse_path_part_string( path_descriptor, 
		                                                    multiple_capturing_fragments )
			  
		  when ::Symbol

        descriptor_instance = ::Magnets::Path::PathPart::Fragment::
        ...
        descriptor_instance = ::Magnets::Path::PathPart::Fragment::OptionalFragment::
    ...
    optional_parts.each do |this_path_descriptor|
      ...
      case this_path_descriptor
        ...
        when ::Magnets::Path::PathPart::Fragment
          ...
          ::Magnets::Path::PathPart::Fragment.new( this_path_descriptor, path_part )
