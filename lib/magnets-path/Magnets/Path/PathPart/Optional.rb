...
class ::Magnets::Path::PathPart::Optional
  ...
  SubOptionStruct = ::Struct.new( :parent_optional_part, :count, :sub_options )
    ...
    initialize_parts( *optional_parts )
    ...
    no_options_struct = ::Magnets::Path::PathPart::Optional::
	...
	def initialize_parts( *optional_parts )
    ...
    if @optional_parts.count > 1
      ...
      base_product_array.product( *remaining_product_arrays ) do |this_cross_product|
        ...
        new_configuration_struct = ::Magnets::Path::PathPart::Optional::
                                     SubOptionStruct.new( self, @non_optional_part_count )
      ...
      sub_option.configurations.each_with_index do |this_sub_configuration_struct, 
        ...
        this_new_configuration_struct = ::Magnets::Path::PathPart::Optional::
  ...
  def match_for_configuration( request_path, configuration_index )
    ...
    matched = match_for_configuration_struct( request_path, configuration_struct )
            ...
            when ::Magnets::Path::PathPart::Optional
              ...
              if sub_option_configuration_index = configuration_struct.sub_options[ this_part ]
                ...
                break unless matched = this_part.match( request_path, 
                                                        sub_option_configuration_index )
              else
                matched = true
                next
              end
