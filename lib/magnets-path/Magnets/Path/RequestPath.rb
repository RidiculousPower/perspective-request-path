...
class ::Magnets::Path::RequestPath
  ...
  FragmentFrameStruct = ::Struct.new( :current_slice_index, 
    ...
    if path_string[ 0 ] == ::Magnets::Path::Parser::PathDelimiter
      path_string.slice!( 0...1 )
    end
    
    @path_parts = path_string.split( ::Magnets::Path::Parser::PathDelimiter )
  ...
  def attached_path
    ...
    unless @attached_path
      raise ::RuntimeError, self.class.to_s + ' is missing attached ' + ::Magnets::Path.to_s + 
  ...
  def new_frame( how_far_ahead = nil )
    ...
    return ::Magnets::Path::RequestPath::FrameStruct.new( new_part_index, 
  ...
  def new_fragment_frame( how_far_ahead = nil )
    ...
    return ::Magnets::Path::RequestPath::FragmentFrameStruct.new( new_fragment_index, 
